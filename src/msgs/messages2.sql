...
('instance_conflict', 'ISC_map_file', 'isc_sync.cpp', NULL, 0, 664, NULL, 'Shared memory area is probably already created by another engine instance in another Windows session', NULL, NULL);
...
('overriding_missing', NULL, 'StmtNodes.cpp', NULL, 0, 817, NULL, 'OVERRIDING clause should be used when an identity column defined as ''GENERATED ALWAYS'' is present in the INSERT''s field list for table table/view @1', NULL, NULL);
...
('BAD_STMT_TYPE', 'precess_statement', 'isql.epp', NULL, 17, 199, NULL, 'Statement type is not recognized', NULL, NULL);
-- GSEC
